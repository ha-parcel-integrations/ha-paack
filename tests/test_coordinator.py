"""Tests for the Paack coordinator: fetching, caching and events.
...
from custom_components.paack.api import PaackApiError
...
from custom_components.paack.coordinator import PaackCoordinator
...
def _in_transit(code: str = ACTIVE_CODE) -> dict:
    ...
    sample["statusCode"] = "scannedAtOrigin"
...
async def test_update_keeps_cached_payload_on_error(hass):
    ...
    client.async_get_parcel.side_effect = PaackApiError("HTTP 500")
