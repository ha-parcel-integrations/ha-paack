"""Diagnostics support for the Paack parcel tracker integration."""
...
#
# Loader payload fields, including nested delivery and pickup data, are redacted.
TO_REDACT = {
...
async def async_get_config_entry_diagnostics(
    ...
    """Return diagnostics for the Paack config entry."""
