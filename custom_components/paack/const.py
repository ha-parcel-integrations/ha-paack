"""Constants for the Paack parcel tracker integration."""
...
# Paack exposes an ETA, pickup-point fields, a deep link and timeline history.
#
...
# Public, postcode-gated consumer tracking route.
#
...
# this repo.
TRACKING_API_URL = "https://paack.co/shipments/tracking/order"
TRACKING_URL = "https://paack.co/shipments/tracking/order?tracking_number={tracking_code}"
...
SUPPORTED_COUNTRIES = ("ES", "PT", "FR", "IT")
